...
1. **Query Transformation**: Multi-Query expansion, Sub-Query decomposition, or HyDE generation via `IQueryTransformationService`.
...
4. **2nd-Stage Re-ranking**: Cross-encoder scoring `(Query, Chunk)` via `IReRankerService`.
