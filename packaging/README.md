...
| OCR bridge scripts and CPU/NVIDIA manifests | Optional OCR provisioning and OCR runtime bridge | Included from `scripts\ocr` | `Test-OnlyRagPublishPayload`; Settings > Configura OCR reports missing bridge/requirements |
